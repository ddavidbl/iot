    ...
    <div class="card m-2 p-2" style="width: 22rem;">
        <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <div><a href="/admin/detail/{{$data['device_id']}}" class="btn btn-info p-1">Show Detail</a></div>
        </div>
        <ul class="list-group list-group-horizontal d-flex justify-content-around list-unstyled ">
            <li class="p-2">
                <ul class="list-unstyled list-group border-0">
                    <li class="text-center">Panjang</li>
                    <li class="text-center">{{$data['panjang']}}</li>
                </ul>
            </li>
            <li class="p-2">
                <ul class="list-unstyled list-group">
                <li class="text-center ">Lebar</li>
                <li class="text-center">{{$data['lebar']}}</li>
            </ul>
            </li>
            <li class="p-2">
                <ul class="list-unstyled list-group">
                <li class="text-center ">Volume</li>
                <li class="text-center">{{$data['volume']}}</li>
            </ul>
            </li>
        </ul>
        <ul class="list-group list-group-horizontal d-flex justify-content-around list-unstyled ">
